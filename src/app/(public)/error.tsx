...
/** Error boundary for the public site routes (UI-20). */
export default function PublicError({ reset }: SegmentErrorProps) {
  return (
      ...
      <Card className="w-full max-w-md">
        <CardContent className="text-center space-y-4">
          ...
          <p className="text-muted-foreground">
            We couldn&apos;t load this page. Please try again — if it keeps failing, the problem is
            on our side.
          </p>
