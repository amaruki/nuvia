                    ...
                    <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                        <div>
                            ...
                            <div className="flex flex-wrap gap-3">
                                <Badge variant="secondary" className="px-3 py-1 text-sm bg-blue-100 text-blue-700 hover:bg-blue-100 border-0">
                                    {job.type}
                                </Badge>
                                <Badge variant="secondary" className="px-3 py-1 text-sm bg-green-100 text-green-700 hover:bg-green-100 border-0">
                                    {job.salary}
                                </Badge>
                ...
                <div className="md:col-span-2 space-y-8">
                    <div className="prose prose-slate max-w-none">
                        ...
                        <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
                            ...
                            <li>Proven software development experience and solid experience with modern frameworks.</li>
                ...
                <div className="space-y-6">
                    ...
                    <div className="border rounded-xl p-6 bg-muted/20">
                        ...
                        <p className="text-sm text-muted-foreground mb-4">
                            {job.company} is a leading innovator in the industry, committed to building products that make a difference.
                        </p>
