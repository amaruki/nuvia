/**
 * Shared helpers for the /api/v1/chapters route handlers.
 */

import type { NextResponse } from "next/server";
import { problemResponse, problems } from "@/lib/http";
import { logger } from "@/lib/logger";
import { ChapterServiceError } from "@/lib/services/chapter.service";

/** Maps ChapterServiceError to its RFC 9457 response; anything else is a 500. */
export async function handleChapterRoute(
