/**
 * POST /api/v1/finance/subscriptions/[id]/resume — resume a PAUSED
 * subscription back to ACTIVE. Requires finance:update.
...
export async function POST(request: NextRequest, { params }: RouteContext) {
  ...
  try {
    ...
    return problemResponse(problemFromFinanceError(error, "Resume subscription error"));
  }
}
