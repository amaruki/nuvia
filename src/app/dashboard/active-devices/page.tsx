      ...
      {loading ? (
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-md">
          <ul className="divide-y divide-gray-200">
            {devices.length === 0 ? (
              <li className="px-6 py-4 text-center text-foreground/50">No active devices found</li>
            ) : (
              devices.map((device) => (
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-info">
              <p>
                If you don&apos;t recognize a device or location, sign out immediately and change
                your password. This will help protect your account from unauthorized access.
              </p>
            </div>
          </div>
        </div>
