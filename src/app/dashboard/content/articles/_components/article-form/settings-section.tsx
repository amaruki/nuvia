  ...
  return (
    <div className="grid gap-8 md:grid-cols-2">
      <div className="space-y-4">
        ...
        />
        <CheckboxField name="isFeatured" label="Feature this article" />
        <CheckboxField name="isPinned" label="Pin this article" />
      </div>
      ...
      <div className="space-y-4">
        ...
        <CheckboxField name="downloadEnabled" label="Enable downloads" />
      </div>
    </div>
  );
}
