...
export function ImportExportBar({ importPublications, exportPublications }: ImportExportBarProps) {
  ...
  return (
    <div className="flex items-center gap-2 p-3 bg-muted/20 rounded-lg border">
      ...
      <div className="flex gap-2">
        ...
        <Button variant="outline" size="sm" onClick={() => exportPublications("csv")}>
          <Download className="mr-2 h-4 w-4" />
          Export CSV
        </Button>
        <Button variant="outline" size="sm" onClick={() => exportPublications("json")}>
          <Download className="mr-2 h-4 w-4" />
          Export JSON
        </Button>
      </div>
