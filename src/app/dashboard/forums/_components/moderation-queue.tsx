    ...
    return (
        ...
        >
            {isLoading ? (
                ...
                <div className="grid gap-5">
                    {posts.map((post) => (
                        <Card key={post.id} className="overflow-hidden border-l-4 border-l-orange-400 hover:shadow-md transition-shadow">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-muted-foreground mt-1">
                                            Posted in <span className="font-medium text-foreground">{post.category.name}</span> • {formatDistanceToNow(new Date(post.createdAt))} ago
                                        </p>
                                    </div>
                                </div>
            ...
            <Dialog open={rejectDialog.open} onOpenChange={(open) => !open && setRejectDialog({ open: false, postId: null })}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <div className="grid gap-2">
                            ...
                            <Select value={rejectReason} onValueChange={setRejectReason}>
                                ...
                                <SelectContent>
                                    ...
                                    <SelectItem value="Spam or promotional content">Spam or promotional content</SelectItem>
                                    <SelectItem value="Harassment or hate speech">Harassment or hate speech</SelectItem>
                    ...
                    <DialogFooter>
                        <Button variant="outline" onClick={() => setRejectDialog({ open: false, postId: null })}>Cancel</Button>
                        <Button variant="destructive" onClick={handleReject}>Reject Post</Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
        </ForumLayout>
