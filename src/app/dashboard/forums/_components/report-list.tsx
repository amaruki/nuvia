                                    ...
                                    <TableRow key={report.id} className="hover:bg-muted/50">
                                        <TableCell className="font-medium">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="truncate max-w-[200px]" title={report.targetContent?.title || report.targetContent?.content}>
                                                    {report.targetContent?.title || report.targetContent?.content?.substring(0, 30) + "..."}
                                                </span>
                                            </div>
                                        </TableCell>
                                        ...
                                        <TableCell>
                                            <Badge variant={report.status === "PENDING" ? "destructive" : "default"} className={cn(report.status === "PENDING" && "bg-red-100 text-red-700 hover:bg-red-100 border-red-200 font-medium")}>
                                                {report.status}
                                            </Badge>
                                        </TableCell>
                        ...
                        <div className="grid gap-6 py-6">
                            <div className="space-y-4">
                                <div className="p-4 bg-muted/40 rounded-lg space-y-2 border border-muted/20">
                                    <div className="flex justify-between items-center mb-2">
                                        <Badge variant="outline" className="font-medium">{selectedReport.targetType}</Badge>
                                        <span className="text-xs text-muted-foreground">ID: {selectedReport.targetId}</span>
                                    </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className="pt-1">
                                            <Badge variant={selectedReport.status === "PENDING" ? "destructive" : "secondary"} className="font-medium">
                            ...
                            <SheetFooter className="flex-col sm:flex-col gap-2 mt-4">
                                {selectedReport.status === "PENDING" ? (
                                    <>
                                        <Button className="w-full gap-2" onClick={() => { handleResolve(selectedReport.id); setIsDetailsOpen(false); }}>
