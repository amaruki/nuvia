...
import { Save, Loader2, Plus, Trash, GripVertical, Video, FileText, HelpCircle, X } from "lucide-react";
                ...
                <div className="grid gap-8">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                General details about your course.
                            </CardDescription>
                        </CardHeader>
                            ...
                            <div className="space-y-4">
                                {moduleFields.length === 0 && (
                                    <div className="text-center py-8 border-2 border-dashed rounded-lg bg-muted/5">
                                        ...
                                        <Button type="button" variant="outline" onClick={() => appendModule({ title: "New Module", lessons: [] })}>
...
function ModuleItem({ index, form, removeModule }: { index: number, form: any, removeModule: (index: number) => void }) {
                    ...
                    {lessonFields.map((lesson, lessonIndex) => (
                        <div key={lesson.id} className="flex items-start gap-2 group">
                            <div className="mt-2.5">
                                {form.watch(`modules.${index}.lessons.${lessonIndex}.type`) === 'video' && <Video className="h-4 w-4 text-muted-foreground" />}
                                {form.watch(`modules.${index}.lessons.${lessonIndex}.type`) === 'article' && <FileText className="h-4 w-4 text-muted-foreground" />}
                                {form.watch(`modules.${index}.lessons.${lessonIndex}.type`) === 'quiz' && <HelpCircle className="h-4 w-4 text-muted-foreground" />}
                            </div>
