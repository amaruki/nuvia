...
export function CertificateView({ certificate }: CertificateViewProps) {
  return (
    <Card
      className="w-full max-w-4xl mx-auto p-8 md:p-12 bg-card text-foreground shadow-xl border-4 border-double border-primary/20 relative overflow-hidden"
    ...
    >
      ...
      <div className="relative z-10 text-center space-y-8">
        ...
        <div className="space-y-2">
          ...
          <Badge
            variant="outline"
            className="text-sm px-4 py-1 tracking-widest uppercase border-primary/20 bg-primary/5"
          >
