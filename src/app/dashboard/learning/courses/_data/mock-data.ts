...
export const courses: Course[] = [
    ...
    modules: [
      ...
      },
      {
        ...
        lessons: [
          {
            id: "l3",
            title: "The Problem with Prop Drilling",
            duration: "12:00",
            type: "video",
            isCompleted: true,
          },
          {
            id: "l4",
            title: "Building Flexible Compound Components",
            duration: "25:00",
            type: "video",
            isCompleted: true,
          },
          {
            id: "l5",
            title: "Context API & Compound Components",
            duration: "20:00",
            type: "video",
            isCompleted: false,
          },
    ...
    reviews: [
      {
        ...
        date: "2 days ago",
        comment:
          "This course completely changed how I think about component composition. Highly recommended!",
      },
      {
        id: "r2",
        user: {
  ...
  },
  {
    ...
    progress: 30,
    image:
      "https://images.unsplash.com/photo-1586717791821-3f44a5638d4f?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
  ...
  },
  {
    ...
    progress: 0,
    image:
      "https://images.unsplash.com/photo-1563986768609-322da13575f3?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
  ...
  },
  {
    ...
    progress: 0,
    image:
      "https://images.unsplash.com/photo-1667372393119-c85c020799a3?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
