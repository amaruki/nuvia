                ...
                <div className="space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Upload your signature to be automatically applied to certificates issued for your courses.
                            </CardDescription>
                        </CardHeader>
                            ...
                            <div className="flex flex-col items-center justify-center p-6 border-2 border-dashed rounded-lg bg-muted/50 transition-colors hover:bg-muted/80">
                                {signature ? (
                                    ...
                                    <div className="text-center space-y-2">
                                        ...
                                        <p className="text-xs text-muted-foreground">PNG or transparent JPG (max 2MB)</p>
                                    </div>
                                )}
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="aspect-[4/3] bg-card border shadow-sm rounded-sm p-3 flex flex-col items-center justify-between text-[6px] text-center mb-2">
                                <div className="font-serif text-[8px] text-primary pt-2">Certificate of Completion</div>
