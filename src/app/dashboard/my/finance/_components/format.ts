/**
 * UI-34 — display helpers for member finance. Formats real stored values
 * only — amounts are numeric(10,2) strings end to end (ADR-0015 §5), never
 * floats, never fabricated.
 */
