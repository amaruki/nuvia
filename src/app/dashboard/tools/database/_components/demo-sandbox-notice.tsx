...
export function DemoSandboxNotice() {
  ...
  return (
    <Alert>
      ...
      <AlertDescription>
        This deployment runs with DEMO_MODE=true. Database health stays read-only in sandboxed mode:
        only SELECT queries run, and no destructive control exists on this page in any mode.
      </AlertDescription>
    </Alert>
  );
}
