    ...
    <div className="space-y-6 p-6 md:p-8">
      ...
      <Card>
        <EmptyState
          ...
          description="Database health is restricted to the superadmin role. Your current role can't view this tool. Contact a superadmin if you believe this is a mistake."
        />
      </Card>
    </div>
  );
