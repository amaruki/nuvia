    ...
    <div className="space-y-6">
      ...
      <Card>
        <EmptyState
          ...
          description="Log-system status is restricted to the superadmin role. Your current role can't view this tool. Contact a superadmin if you believe this is a mistake."
        />
      </Card>
    </div>
  );
