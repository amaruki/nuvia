      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="shadow-sm">
          <CardContent className="p-6">
            ...
            <div className="flex flex-col mt-3">
              <span className="text-2xl font-bold">{formatPercentage(statistics.goalCompletionRate)}</span>
              <span className="text-xs text-muted-foreground mt-1">
            ...
            <div className="space-y-5">
              {statistics.topPerformingCommittees
                ...
                .map((committee, index) => {
                  ...
                  const maxScore = Math.max(...statistics.topPerformingCommittees.map(c => c.impactScore));
                  ...
                  <div key={committee.committeeId} className="space-y-2">
                    ...
                    <div className="flex justify-between text-xs text-muted-foreground">
                         <span>Goals: <span className="font-medium">{formatPercentage(committee.goalCompletionRate)}</span></span>
                         <span>Impact: <span className="font-medium">{committee.impactScore.toFixed(1)}</span></span>
                    </div>
                  </div>
                )})}
            </div>
