        ...
        <CardContent className="p-0">
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Button variant="ghost" size="sm" onClick={onViewAllActivities} className="text-xs">
                View all
              </Button>
            </div>
              ...
              {activities.length === 0 ? (
                <div className="text-center py-8 text-foreground/50">
                  ...
                  <p className="text-sm mt-2">
                    Recent forum posts, discussions, and events will be displayed here.
                  </p>
                </div>
              ) : (
                sortedActivities.map((activity) => (
                  <div key={activity.id} className="p-4 rounded-lg border bg-card border-border">
