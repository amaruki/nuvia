...
const communityHighlights = [
  {
    ...
    description:
      "Jane Smith has been recognized for her outstanding contributions to the community.",
  ...
  },
  {
    ...
    description:
      "Our community has reached 1000 members! Thank you for being part of this journey.",
...
export function CommunityHighlightsWidget({ onViewAllHighlights }: CommunityHighlightsWidgetProps) {
  return (
    <WidgetContainer
        ...
        <CardContent className="p-0">
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Button variant="ghost" size="sm" onClick={onViewAllHighlights} className="text-xs">
                View all
              </Button>
            </div>
              ...
              {communityHighlights.length === 0 ? (
                <div className="text-center py-8 text-foreground/50">
                  ...
                  <p className="text-sm mt-2">
                    Community achievements and notable activities will be displayed here.
                  </p>
                </div>
              ) : (
                communityHighlights.map((highlight) => (
                  <div key={highlight.id} className="p-4 rounded-lg border bg-card border-border">
