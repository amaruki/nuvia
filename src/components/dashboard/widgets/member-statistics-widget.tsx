              ...
              <div className="p-4 rounded-lg border bg-card border-border">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm font-medium" style={{ color: 'var(--muted-foreground)' }}>Total</span>
                  </div>
              ...
              <div className="p-4 rounded-lg border bg-card border-border">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm font-medium" style={{ color: 'var(--muted-foreground)' }}>Active</span>
                  </div>
                  <Badge className="bg-chart-2/20 text-success">
                    {activePercentage}%
                  </Badge>
                </div>
                <div className="text-2xl font-bold" style={{ color: 'var(--foreground)' }}>
              ...
              <div className="p-4 rounded-lg border bg-card border-border">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm font-medium" style={{ color: 'var(--muted-foreground)' }}>New</span>
                  </div>
              ...
              <div className="p-4 rounded-lg border bg-card border-border">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm font-medium" style={{ color: 'var(--muted-foreground)' }}>Expired</span>
                  </div>
                ...
                <div className="flex items-center text-xs mt-1" style={{ color: 'var(--destructive)' }}>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <div className="w-full rounded-full h-2" style={{ backgroundColor: 'var(--muted)' }}>
                  <div
                    className="h-2 rounded-full"
                    style={{ width: `${expiredPercentage}%`, backgroundColor: 'var(--destructive)' }}
                  ></div>
                </div>
              </div>
            </div>
