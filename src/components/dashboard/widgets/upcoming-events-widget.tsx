            ...
            <div className="space-y-4 max-h-96 overflow-y-auto">
              {sortedEvents.length === 0 ? (
                <div className="text-center py-8" style={{ color: 'var(--muted-foreground)' }}>
                  <Calendar className="h-8 w-8 mx-auto mb-2" style={{ color: 'var(--muted-foreground)', opacity: '0.4' }} />
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 mb-1">
                          <h3 className="text-sm font-semibold line-clamp-1" style={{ color: 'var(--foreground)' }}>
                            {event.title}
                          </h3>
                          {isEventToday(event.startDate) && (
                            <Badge className="" style={{ backgroundColor: 'var(--info)', color: 'var(--info-foreground)' }}>
                              Today
                            </Badge>
                          )}
                          {isEventTomorrow(event.startDate) && (
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex space-x-2">
                        {event.isCheckedIn ? (
                          <Badge className="" style={{ backgroundColor: 'var(--chart-2)', color: 'var(--chart-2-foreground)' }}>
