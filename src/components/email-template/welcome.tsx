          ...
          <Container className="max-w-lg mx-auto bg-white rounded-lg shadow-lg">
            ...
            <Section className="p-8">
              <Text className="text-gray-700 leading-6 mb-6">
                Thank you for joining our platform! Your account has been successfully created and we're excited to have you with us.
              </Text>
              ...
              <Section className="bg-purple-50 rounded-lg p-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-start">
                    ...
                    <Text className="text-sm text-gray-600">Complete your profile to get personalized recommendations</Text>
                  </div>
                  <div className="flex items-start">
                    <svg className="w-5 h-5 text-purple-600 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                    <Text className="text-sm text-gray-600">Explore our features and discover what you can do</Text>
                  </div>
                  <div className="flex items-start">
                    <svg className="w-5 h-5 text-purple-600 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                    <Text className="text-sm text-gray-600">Connect with our community and get support</Text>
                  </div>
                </div>
              </Section>
              ...
              <div className="text-center mt-6">
                <Text className="text-sm text-gray-600">
                  Need help? <Link href="/support" className="text-purple-600 font-medium">Contact our support team</Link>
                </Text>
              </div>
            </Section>
