...
export const updateProfileSchema = z.object({
  ...
  externalLinks: z.array(externalLinkSchema).max(10, 'You can add up to 10 external links').optional(),
});
...
export const deviceInfoSchema = z.object({
  ...
  deviceType: z.string().min(1, 'Device type is required').max(50, 'Device type must be less than 50 characters'),
