...
export const CATEGORY_TYPES: CategoryType[] = [
  'content', 'article', 'announcement', 'publication', 'event', 'forum', 'job', 'resource'
] as const;
...
export const CATEGORY_SCOPES: CategoryScope[] = [
  'global', 'chapter', 'committee'
] as const;

// Display information
export const CATEGORY_TYPE_DISPLAY: Record<CategoryType, {
  name: string;
  description: string;
  icon: string;
  color: string;
...
export const CATEGORY_STATUS_DISPLAY: Record<CategoryStatus, {
  name: string;
  description: string;
  icon: string;
  color: string;
...
export const CATEGORY_SCOPE_DISPLAY: Record<CategoryScope, {
  name: string;
  description: string;
  icon: string;
  color: string;
