...
export interface UserActivity {
  id: string
  userId: string
  activityType: "login" | "logout" | "profile_update" | "password_change" | "role_change" | "security_event"
  description: string
  ipAddress?: string
  userAgent?: string
  timestamp: Date
...
export interface UserManagementAction {
  type: "suspend" | "activate" | "ban" | "unban" | "change_role" | "verify_email" | "verify_phone" | "reset_password" | "force_logout"
  userId: string
  reason?: string
  metadata?: Record<string, any>
}
